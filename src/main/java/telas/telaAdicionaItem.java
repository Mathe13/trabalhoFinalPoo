 ...
 * @author Alison Lopes
 */
public class telaAdicionaItem extends javax.swing.JFrame {
    Estoque estoque;
    /**
     * Creates new form telaAdicionaItem
     * @param estoque1
     */
    public telaAdicionaItem(Estoque estoque1) {
    ...
    private void initComponents() {
        ...
        confirmaItem.setText("Inserir item");
    ...
    private void confirmaItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_confirmaItemActionPerformed
        ...
        int ultimo_id;
        ultimo_id=0;
        if ((this.estoque.getItens()).size()>0){
            ultimo_id = ((this.estoque.getItens()).get((this.estoque.getItens()).size()-1)).getId();
        }
        ...
        System.out.println(Integer.toString(ultimo_id+1));
        aux = new Item((ultimo_id+1),this.nomeItem.getText(),unidade ,Float.parseFloat(this.tamanho.getText()),Float.parseFloat(this.preco.getText()),0.0f);
        this.estoque.addItem(aux);
